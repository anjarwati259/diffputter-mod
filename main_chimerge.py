...
from dataset_chimerge import (load_dataset, get_eval, mean_std,
...
if __name__ == '__main__':
    ...
    #    - chimerge      : ChiMergeDiscretizer (untuk decode numerik)
    ...
    (train_X, test_X,
     ...
     emb_model,
     emb_sizes,
     chimerge,       # [BARU] ChiMergeDiscretizer (atau None jika tidak ada numerik)
    ...
    for iteration in range(args.max_iter):
        ...
        with open(f'{result_save_path}/result_chimerge.txt', 'a+') as f:
            f.write(
